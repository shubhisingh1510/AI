...
# CLASS_INFO / DISCLAIMER live in clinical_info.py (zero dependencies) rather than here, so
# webapp/mock_classifier.py can reuse the same real clinical text without pulling in torch --
# re-exported below so existing `from inference_core import CLASS_INFO, DISCLAIMER` call
# sites don't need to change.
from clinical_info import CLASS_INFO, DISCLAIMER  # noqa: E402,F401
